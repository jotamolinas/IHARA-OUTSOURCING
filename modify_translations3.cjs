...
const replacements = [
  [
    /"La formación de nuestra EAS a través de Ihara fue el proceso más eficiente que experimentamos en el Cono Sur\. Seguridad jurídica de primer nivel\."/g,
  ...
  [
    /"El análisis de mercado y la orientación sobre la Ley 60\/90 ahorraron cientos de miles de dólares en costos iniciales\. Recomendamos a Ihara 100%\."/g,
  ...
  [
    /"Gracias a Ihara descubrimos el valor de Ciudad del Este para el ensamblaje y distribución a Brasil\."/g,
