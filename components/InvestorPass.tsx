...
export const InvestorPassSection: React.FC<InvestorPassProps> = ({ lang }) => {
  ...
  return (
    <section className="py-24 bg-stone-50 overflow-hidden border-t border-stone-200" id="investor-pass">
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          ...
          <div className="flex-1 w-full relative">
            ...
            >
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-ihara-dark/90 via-ihara-dark/30 to-transparent flex flex-col justify-end p-8 text-left">
            ...
            <motion.div
              ...
              className="bg-ihara-dark p-8 rounded-3xl border border-white/10 text-white relative overflow-hidden text-left"
            >
              ...
              <a
                ...
                className="inline-flex items-center gap-3 bg-[#25D366] text-white px-8 py-4 rounded-xl font-black text-xs tracking-widest uppercase hover:bg-white hover:text-[#25D366] transition-all shadow-lg relative z-10"
              >
